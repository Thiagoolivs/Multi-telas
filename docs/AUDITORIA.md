...
|---|---|---|---|---|
| 🔴 | ⬜ | Mídia em base64 no config/DB (`admin.js` `readAsDataURL`); limite de corpo 2MB | Object storage (S3/R2) + CDN + presigned upload + pré-cache no device | Destrava vídeo, escala, offline |

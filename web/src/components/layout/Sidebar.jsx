...
import {
  LayoutDashboard, MonitorPlay, Megaphone, HardDrive, Bell, Users2, Settings, LifeBuoy, CreditCard, Cake, Wand2, ImagePlus,
} from 'lucide-react';
...
const NAV = [
  { section: 'Operação', items: [
    ...
    { id: 'images', label: 'Imagens IA', icon: ImagePlus },
